...
// calcurate B
double Make_B_component(int ele, double *para, double *out_B_component, information *info, int return_mode = 0, double *out_a_matrix = nullptr);
double Make_B_component_for_SSIGA(int ele_disp, double *para_disp, double *out_B_component, information *info, int return_mode = 0, double *out_c_matrix = nullptr);
...
void make_virtual_crack_extension_area_on_free_surface(J_point_info &jp, J_info &J, int id, int e_on_curve, bool islocal, information *info);
