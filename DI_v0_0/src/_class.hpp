...
public:
	...
	// for free surface
	vector<vector<double>> coord_fs;
	vector<vector<double>> normal_fs;
	vector<double> J_val_fs;
	vector<double> J_integral_area_fs;

	vector<double> delta_arc_length_fs;
	vector<double> delta_arc_length_at_half_para_fs;
